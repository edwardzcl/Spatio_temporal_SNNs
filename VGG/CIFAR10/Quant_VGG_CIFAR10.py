...
# learning rate, # decay it by 10×  after 200 epochs, and set resume = True
...
with tf.device('/cpu:0'):
    ...
    def model(x_crop, y_, is_train, reuse):
        ...
        with tf.variable_scope("model", reuse=reuse):
            net = tl.models.VGG_CIFAR10(x_crop, y_, pretrained=False, k=args.k, B=args.B, end_with='fc1000', n_classes=10, is_train=is_train, reuse=reuse, name=None)

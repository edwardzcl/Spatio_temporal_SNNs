...
neuron0 = (64*24*24 * 2 + 64*12*12 + 128*12*12*2 + 128*6*6 + 256*6*6*2 + 256*3*3 + 512*3*3 + 512*1*1) * 1
neuron1 = (64*24*24 * 2 + 64*12*12 + 128*12*12*2 + 128*6*6 + 256*6*6*2 + 256*3*3 + 512*3*3 + 512*1*1) * 2
neuron2 = (64*24*24 * 2 + 64*12*12 + 128*12*12*2 + 128*6*6 + 256*6*6*2 + 256*3*3 + 512*3*3 + 512*1*1) * 4
...
plt.title("Sparsity on CIFAR100", fontproperties=roman) 
  
plt.show() 

plt.savefig('scnn_spike_neuron_CIFAR100.svg',format='svg')

...
def VGG_CIFAR100_FULL(x_crop, y_, pretrained=False, end_with='fc1000', n_classes=1000, is_train=True, reuse=False, name=None):
    ...
    with tf.variable_scope("model", reuse=reuse):
         ...
         net = Conv2d(net, n_filter=64, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv0')
         net = BatchNormLayer(net, act=tf.nn.relu, is_train=is_train,  name='bn0')

         net = Conv2d(net, n_filter=64, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv1')
         net = BatchNormLayer(net, act=tf.nn.relu, is_train=is_train,  name='bn1')

         net = Conv2d(net, n_filter=64, filter_size=(2, 2), strides=(2, 2), padding='SAME', b_init=None, name='conv2')
         net = BatchNormLayer(net, act=tf.nn.relu, is_train=is_train,  name='bn2')

         net = Conv2d(net, n_filter=128, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv3')
         net = BatchNormLayer(net, act=tf.nn.relu, is_train=is_train,  name='bn3')

         net = Conv2d(net, n_filter=128, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv4')
         net = BatchNormLayer(net, act=tf.nn.relu, is_train=is_train,  name='bn4')

         net = Conv2d(net, n_filter=128, filter_size=(2, 2), strides=(2, 2), padding='SAME', b_init=None, name='conv5')
         net = BatchNormLayer(net, act=tf.nn.relu, is_train=is_train,  name='bn5')

         net = Conv2d(net, n_filter=256, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv6')
         net = BatchNormLayer(net, act=tf.nn.relu, is_train=is_train,  name='bn6')

         net = Conv2d(net, n_filter=256, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv7')
         net = BatchNormLayer(net, act=tf.nn.relu, is_train=is_train,  name='bn7')

         net = Conv2d(net, n_filter=256, filter_size=(2, 2), strides=(2, 2), padding='SAME', b_init=None, name='conv8')
         net = BatchNormLayer(net, act=tf.nn.relu, is_train=is_train,  name='bn8')

         net = Conv2d(net, n_filter=512, filter_size=(3, 3), strides=(1, 1), padding='SAME', b_init=None, name='conv9')
         net = BatchNormLayer(net, act=tf.nn.relu, is_train=is_train,  name='bn9')

         net = Conv2d(net, n_filter=512, filter_size=(3, 3), strides=(1, 1), padding='VALID', b_init=None, name='conv10')

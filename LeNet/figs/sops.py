...
#mac0 = (16*24*24*16*5*5 + 16*12*12*16*2*2 + 32*8*8*16*5*5 + 32*4*4*32*2*2 + 256*1*1*32*4*4)*3
#mac1 = mac0
#mac2 = mac0
...
plt.title("Computing operations on MNIST", fontproperties=roman) 

plt.show()

plt.savefig('scnn_sop_mnist.svg',format='svg')

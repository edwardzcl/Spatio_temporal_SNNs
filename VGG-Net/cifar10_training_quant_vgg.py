...
with tf.device('/cpu:0'):
    ...
    def model(x_crop, y_, is_train, reuse):
        ...
        with tf.variable_scope("model", reuse=reuse):
            net = tl.models.VGG_CIFAR10(x_crop, y_, pretrained=False, k=k, B=B, end_with='fc1000', n_classes=10, is_train=is_train, reuse=reuse, name=None)
    ...
    ## train
    n_epoch = 50000
    learning_rate = 0.01 #decay it by 10× every 200 epochs, until it is 0.0000001
    print_freq = 1
